...
#[Fillable(['name', 'email', 'password', 'provider', 'provider_id', 'avatar', 'account_type', 'role', 'corporate_id', 'admin_id', 'is_verified', 'permissions', 'designation', 'otp_code', 'otp_expires_at', 'email_verified_at'])]
